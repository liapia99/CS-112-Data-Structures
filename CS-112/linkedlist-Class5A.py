#Julia Piascik 
#Extend the Linked List module provided to add four more options:1. Get the Sum of the Data in the linked list2. Get the average of the data in the linked list3. Get the minimum value in the linked list4. Get the maximum value in the linked list
...
while choice != 14:
    ...
    if choice==1:
        ...
        print("Removed last item")
         ...
         x = My_List.get_average()
         print("Average is ", x)
    elif choice==12:
         x = My_List.get_min()
         print("Mininum value is ", x)
    elif choice==13:
         x = My_List.get_max()
